...
BLOG_AUTHOR = "Miguel Fiandor"  # (translatable)
...
BLOG_EMAIL = "miguel.fiandor.gutierrez@gmail.com"
BLOG_DESCRIPTION = "Miguel Fiandor Data Analyst & Engineer Freelance Site"  # (translatable)
